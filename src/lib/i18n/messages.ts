...
const en: Dict = {
  ...
  "auth.subtitle": "This workspace is private. Enter the access password or use a provider.",
  "auth.password": "Access password",
  "auth.signin": "Sign in",
  "auth.signing": "Signing in…",
  "auth.invalid": "Incorrect password. Try again.",
  "auth.or": "or continue with",
  "auth.github": "Continue with GitHub",
  "auth.google": "Continue with Google",
  "auth.demoHint": "Demo password: locus",
...
const uk: Dict = {
  ...
  "auth.subtitle": "Цей робочий простір приватний. Введіть пароль доступу або скористайтеся провайдером.",
  "auth.password": "Пароль доступу",
  "auth.signin": "Увійти",
  "auth.signing": "Вхід…",
  "auth.invalid": "Невірний пароль. Спробуйте ще раз.",
  "auth.or": "або увійдіть через",
  "auth.github": "Увійти через GitHub",
  "auth.google": "Увійти через Google",
  "auth.demoHint": "Демо-пароль: locus",
  "auth.signout": "Вийти",
...
const pl: Dict = {
  ...
  "auth.subtitle": "Ta przestrzeń jest prywatna. Wpisz hasło dostępu lub użyj dostawcy.",
  "auth.password": "Hasło dostępu",
  "auth.signin": "Zaloguj się",
  "auth.signing": "Logowanie…",
  "auth.invalid": "Nieprawidłowe hasło. Spróbuj ponownie.",
  "auth.or": "lub kontynuuj przez",
  "auth.github": "Kontynuuj z GitHub",
  "auth.google": "Kontynuuj z Google",
  "auth.demoHint": "Hasło demo: locus",
